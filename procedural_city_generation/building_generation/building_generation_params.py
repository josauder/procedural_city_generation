...
Param("windowwidth_min",0.013,"The minimum width of a window","float"),
Param("windowwidth_max",0.025,"The maximum width of a window","float"),
...
Param("windowdist_max_house",0.03,"The maximum distance between two windows for a house","float"),
Param("windowdist_max_not_house",0.03,"The maximum distance between two windows for not-houses","float"),
